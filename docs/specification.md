...
A front-end-only flashcards web application to help Russian speakers learn English vocabulary through interactive flashcards. Built using **Vite**, **React**, and **TypeScript**. The app uses **static data** to render flashcards grouped into categories. It supports study, quiz, and review modes, with performance tracked using in-browser state.
...
- Flashcards show an English word by default.
- Clicking a card flips it to reveal the Russian translation.
...
- Two types of quizzes:
  - **Multiple Choice**
    - One English word, 4 Russian options (1 correct + 3 distractors)
    - Distractors are statically defined per question
  - **Fill in the Blank**
    - English word shown, user types the Russian word
...
- Shows available categories: Animals, Food, Furniture, Clothes, Home, City, Shopping, Travel, Verbs
